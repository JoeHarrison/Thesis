...
class RubiksEnv2(gym.Env):
    def __init__(self, size=2, metric='quarter', pomdp=False, solved_reward=1.0, unsolved_reward=0.0, seed=None):
        self.size = size
...
if __name__ == "__main__":
    env = RubiksEnv2(size=2, metric='quarter', pomdp=False, solved_reward=1.0, unsolved_reward=0.0, seed=None)
    for x in range(12):
        env.curriculum_reset(level=13)
