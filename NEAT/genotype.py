...
class Genotype(object):
    def __init__(self, 
        ...
        # Tuples of: id, non_linearity, bias, layer, ff_order
        self.neuron_genes = []
    ...
    def add_neuron(self, maximum_innovation_number, innovations):
        ...
        if possible_to_split:
            ...
            neuron = [new_id, nonlinearity, np.random.randn(), layer, fforder]
            ...
            self.connection_genes[(input_neuron, new_id)] = [innovation_number, input_neuron, new_id, self._initialise_weight(), True]
